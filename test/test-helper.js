...
assert.ok(Helper.isValidData(instance));
...
assert.ok(Helper.makespan(subInstance) === 46);
assert.ok(Helper.makespan(Helper.toggle(subInstance, 1, 2)) === 42);
...
assert.ok(Helper.makespan(Helper.insertBefore(insertedInstance, 1, Helper.get(sortedInstance, 3))) === 51);
assert.ok(Helper.makespan(Helper.insertBefore(insertedInstance, 2, Helper.get(sortedInstance, 3))) === 51);
assert.ok(Helper.makespan(Helper.insertBefore(insertedInstance, 3, Helper.get(sortedInstance, 3))) === 50);

var lastInstance = Helper.insertBefore(insertedInstance, 3, Helper.get(sortedInstance, 3));
assert.ok(Helper.makespan(Helper.insertBefore(lastInstance, 1, Helper.get(sortedInstance, 4))) === 54);
assert.ok(Helper.makespan(Helper.insertBefore(lastInstance, 2, Helper.get(sortedInstance, 4))) === 57);
assert.ok(Helper.makespan(Helper.insertBefore(lastInstance, 3, Helper.get(sortedInstance, 4))) === 58);
assert.ok(Helper.makespan(Helper.insertBefore(lastInstance, 4, Helper.get(sortedInstance, 4))) === 58);
